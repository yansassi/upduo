          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 3 && (
              ...
              >
                ...
                {/* Heroes Grid */}
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 max-h-80 overflow-y-auto border border-gray-200 rounded-lg p-4">
                  ...
                  {LINES.map((line) => (
                    ...
                    >
                      <img
                        ...
                        alt={line}
                        className="w-16 h-16 mx-auto rounded-lg shadow-md mb-2 bg-transparent"
                      />
